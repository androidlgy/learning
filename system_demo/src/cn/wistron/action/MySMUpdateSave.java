...
public class MySMUpdateSave extends ActionSupport {
	...
	public String execute() throws Exception{
	    ...
	    out.print("<script language='javascript'>alert('恭喜你，修改成功！');window.location='MySMManager.action?Sensor_ID="+SM_SensorID+"';</script>");
    	out.flush();
    	out.close();
	    return null;
	}

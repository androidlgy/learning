...
public class StorehouseManager extends ActionSupport {
	...
	public List<MuseumBean> getMuseumbeanlist() {
		return museumbeanlist;
	}
	public void setMuseumbeanlist(List<MuseumBean> museumbeanlist) {
		this.museumbeanlist = museumbeanlist;
	}
	...
	public String execute() throws Exception{
		...
		if(!isInValid(Building_MuseumID)){
			strwhere+=" and Building_MuseumID="+Building_MuseumID;
		}
		if(!isInValid(Storehouse_BuildingID)){
			strwhere+=" and Storehouse_BuildingID="+Storehouse_BuildingID;
		}
		buildingbeanlist = new BuildingDao().getList("", "Building_Name");
		storehousebeanlist=new StorehouseDao().getList(strwhere, "Storehouse_Name");
		museumbeanlist=new MuseumDao().getList("", "Museum_Name");
		return SUCCESS;
	}

...
public class StorehouseAddSave extends ActionSupport {
	...
	public String execute() throws Exception{
		...
		List<StorehouseBean> list = new StorehouseDao().getList("Storehouse_Name='"+Storehouse_Name+"' and Storehouse_BuildingID='"+Storehouse_BuildingID+"'", "");
		if(list.size()>0){
		...
		//跳转
		out.print("<script language='javascript'>alert('添加成功！');window.location='StorehouseManager.action';</script>");
		out.flush();out.close();return null;
	}

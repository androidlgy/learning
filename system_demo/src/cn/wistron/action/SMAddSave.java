...
public class SMAddSave extends ActionSupport {
	...
	public void setMotion_Value(String motion_Value) {
		...
		public String execute() throws Exception{
           ...
           new SMDao().add(bean);
		   //添加成功，跳转
		   out.print("<script language='javascript'>alert('添加成功');window.location='SMManager.action?Sensor_ID="+SM_SensorID+"';</script>");
		   out.flush();
	       out.close();
		   return null;
		}

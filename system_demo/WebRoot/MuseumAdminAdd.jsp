...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
            <tr>
              <td background="Images/mainMenuBg.jpg" style="padding-left:25px;height: 30px;padding-top: 0px;max-height: 30px;">添加档案馆管理员</td>
            </tr>
            <tr>
              <td height="510px" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="MuseumAdminAdd.action" onSubmit="return mycheck()" >

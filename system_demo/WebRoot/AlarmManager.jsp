...
<body>
<center>
  <table  height="29%" width="80%" style="min-width:min-width:1135px;" >
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="30px" background="Images/mainMenuBg.jpg" style="padding-left:25px;">报警日志</td>
            </tr>
            <tr>
              <td height="30px" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="AlarmManager.action">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
              ...
              <td height="485px" valign="top">
               ...
               <%--      <td bgcolor="#D5E4F4"><strong>设备名称</strong></td> --%>
                    <td bgcolor="#D5E4F4"><strong>警报时间</strong></td>                  
                    <td bgcolor="#D5E4F4"><strong>警报详情</strong></td>
             <%--        <td bgcolor="#D5E4F4"><strong>操作</strong></td> --%>
                  ...
                  <tr align="center">
                  <%if(session.getAttribute("type").toString().equals("1")){%>
                  <td height="25px" align="center">${emp.alarm_MuseumName}</td>
                  <%}%>
                <%--   <td height="25" align="center">${emp.alarm_SensorName}</td> --%>
                  <td><fmt:formatDate value="${emp.alarm_Time}" type="both"/></td>
                  <td align="center">${emp.alarm_Thing}</td>
                  </tr>
...
<td colspan="3" align="center">
  				...
  				<a href="AlarmManager.action?currentPage=1">首页</a>
  				<a href="AlarmManager.action?currentPage=${requestScope.pageBean.currentPage-1}">上一页 </a>
  				<a href="AlarmManager.action?currentPage=${requestScope.pageBean.currentPage+1}">下一页 </a>
  				<a href="AlarmManager.action?currentPage=${requestScope.pageBean.totalPage}">末页</a>
  			</td>
</tr>
 </table>

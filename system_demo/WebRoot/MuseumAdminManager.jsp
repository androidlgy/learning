                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <s:iterator id="aa" value="list">
                    <tr align="center">
                      ...
                      <td align="center"><a href="MuseumAdminUpdate.action?Manager_ID=${Manager_ID}">修改</a> <a href="MuseumAdminDel.action?Manager_ID=${Manager_ID}" onClick="return confirm('确定要删除该档案馆管理员吗？')">删除</a></td>
                    </tr>
                  </s:iterator>
                </table></td>
            </tr>

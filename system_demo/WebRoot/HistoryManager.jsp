                    ...
                    <td width="78%">查询：
                     <%if(session.getAttribute("type").toString().equals("1")){%>                 
                      ...
                      <input name="SearchKey" type="text" class="text1" id="SearchKey">
                                            开始时间：<input type="text" id="beginTime" name="beginTime" onclick="return showCalendar('beginTime', 'y-mm-dd');"  />
                                            截止时间：<input type="text" id="endTime" name="endTime" onclick="return showCalendar('endTime', 'y-mm-dd');"  />                   

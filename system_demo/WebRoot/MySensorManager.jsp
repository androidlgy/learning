...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="MySensorManager.action">
                <table width="100%%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="22%" height="30" style="padding-left:20px;"> 功能导航： <a href="MySensorAdd.action">添加设备</a></td>
                    <td width="78%">查询：
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <s:iterator id="aa" value="slist">
                    <tr align="center">
                      ...
                      <td align="center"><a href="MySMManager.action?Sensor_ID=${Sensor_ID}">动作</a> <a href="MySensorUpdate.action?Sensor_ID=${Sensor_ID}">修改</a> <a href="MySensorDelete.action?Sensor_ID=${Sensor_ID}" onClick="return confirm('确定要删除该设备吗？')">删除</a></td>
                    </tr>
                  </s:iterator>
                </table></td>
            </tr>

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="MyStorehouseManager.action">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="22%" height="30" style="padding-left:20px;"> 功能导航： <a href="MyStorehouseAdd.action">添加库房</a></td>
                    <td width="78%">查询：
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <s:iterator id="aa" value="storehousebeanlist">
                    <tr align="center">
                      ...
                      <td align="center"><a href="MyStorehouseUpdate.action?Storehouse_ID=${Storehouse_ID}">修改</a> <a href="MyStorehouseDel.action?Storehouse_ID=${Storehouse_ID}" onClick="return confirm('确定要删除该库房吗？')">删除</a></td>
                    </tr>
                  </s:iterator>
                </table></td>
            </tr>
